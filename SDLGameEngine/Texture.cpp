...
void Texture::render(int x, int y, SDL_Rect* clip, SDL_Rect* renderQuad, double angle, SDL_Point* center, SDL_RendererFlip flip)
{
	//Set rendering space and render to screen
	SDL_Rect dRect;
	if (renderQuad == NULL)
	{
		dRect = { x, y, mWidth, mHeight };
	...
	//Render to screen
	SDL_RenderCopyEx(globalRenderer, mTexture, clip, &dRect, angle, center, flip);
}
